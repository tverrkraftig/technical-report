...
\usepackage[english]{babel}                         % formats stuff (dates etc) like englishfolklike it.  See http://www.phys.ethz.ch/~ihn/latex/babel.pdf
\usepackage[babel=once]{csquotes}                 % csquotes is recommended by biber for some reason
